      ...
      <Grid container spacing={5} justifyContent="center">
        <Grid item xs={12} sm={10} lg={9}>
          <Stack alignItems="center" justifyContent="center" spacing={2}>
            ...
            Every issue or bug reported helps us improve our app, This translates to a better user experience. So please use this form to report any issue or bug you may encounter.
            </Typography>
          </Stack>
        </Grid>
        <Grid item xs={12} sm={10} lg={9}>
          ...
          <Grid item xs={12} md={6}>
            ...
            {imagePreview && (
              <img src={imagePreview} alt="Selected file" style={{ maxWidth: '100%', marginTop: '10px' }} />
            )}
          </Grid>
            <Grid item xs={12}>
