...
// step options
const steps = ['Shipping address', 'Payment details', 'Review your order', 'Payment details', 'Payment details', ];
...
const ValidationWizard = () => {
  ...
  return (
    <MainCard style={{ width: '80%', margin: '0 auto'}}  title="New Automation Template">
          ...
          <>
            ...
            {activeStep === steps.length - 1 && (
              <Stack direction="row" justifyContent={activeStep !== 0 ? 'space-between' : 'flex-end'}>
                ...
                <AnimateButton>
                  <Button variant="contained" color="grey" onClick={handleNext} sx={{ my: 3, ml: 1 }}>
                    Cancel
                  </Button>
                </AnimateButton>
                <AnimateButton>
