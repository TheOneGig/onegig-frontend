  ...
  >
    ...
    {signatureMode === 'canvas' ? (
      <>
        ...
        <Button  variant="outline" onClick={save}>Insert Signature</Button>
        <Button mt={20} ml={20} variant="outline" onClick={clear}>Clear</Button>
      </>
    ) : (
      <div style={{ marginTop: 20 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: 20 }}>
          <Button variant="outline" onClick={insertTextSignature}>Insert Signature</Button>
        </div>
      </div>
    )}
  </Modal>
